...
CREATE TABLE lend_borrow_returns (
...
CREATE INDEX idx_lend_borrow_returns_lend_borrow_id ON lend_borrow_returns(lend_borrow_id);
CREATE INDEX idx_lend_borrow_returns_created_at ON lend_borrow_returns(created_at); 