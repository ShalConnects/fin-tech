-- Fix History Tracking - Simple Version
-- This version removes auth.uid() dependency and uses a simpler approach

-- 1. Drop existing system
...
CREATE INDEX IF NOT EXISTS idx_purchase_history_changed_at ON purchase_history(changed_at);
...
-- 10. Test the system
SELECT 
    'SIMPLE HISTORY TRACKING SYSTEM SETUP COMPLETE' as status,
